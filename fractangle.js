var calculateNextTriangles = function(triangle) {
	...
	inbetween0and1.y = inbetween0and1.y + Math.random() * distanceBetweenPoints / 5;
	inbetween0and2.y = inbetween0and2.y + Math.random() * distanceBetweenPoints / 5;
	inbetween1and2.y = inbetween1and2.y + Math.random() * distanceBetweenPoints / 5;
